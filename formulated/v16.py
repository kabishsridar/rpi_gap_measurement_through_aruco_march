...
class MeasurementApp:
    ...
    def _build_tab_settings(self):
        ...
        for choice in ["Left", "Right"]: tk.Radiobutton(rf, text=choice, variable=self.fixed_side, value=choice, bg=C_PANEL, fg=C_TEXT_BRT, font=F_BODY, selectcolor=C_GREEN).pack(side="left", padx=40)
        def sld(l, v, c, lo, hi):
